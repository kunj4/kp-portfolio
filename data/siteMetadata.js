...
const siteMetadata = {
  title: 'Kunj - Senior Security Engineer',
  author: 'Kunj Patel',
  ...
  openToWork: true,
  description:
    'Security engineering is where logic meets intuition, where we model the unknown, and defend against the unseen.',
  language: 'en-us',
  theme: 'system', // system, dark or light
  siteUrl: 'https://borntosting.com/',
  analyticsURL: 'https://cloud.umami.is/share/0JfAtzGN9Ionozmh/borntosting.com',
